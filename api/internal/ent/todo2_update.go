...
func (t *Todo2Update) SetCreatedAt(value time.Time) *Todo2Update {
	t.mutation.SetCreatedAt(value)
	return t
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (t *Todo2Update) SetNillableCreatedAt(value *time.Time) *Todo2Update {
	if value != nil {
...
func (t *Todo2Update) SetName(s string) *Todo2Update {
	t.mutation.SetName(s)
	return t
}

// SetNillableName sets the "name" field if the given value is not nil.
func (t *Todo2Update) SetNillableName(s *string) *Todo2Update {
	if s != nil {
		t.SetName(*s)
	}
	return t
...
// SetCreatedAt sets the "created_at" field.
func (to *Todo2UpdateOne) SetCreatedAt(t time.Time) *Todo2UpdateOne {
	to.mutation.SetCreatedAt(t)
	return to
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (to *Todo2UpdateOne) SetNillableCreatedAt(t *time.Time) *Todo2UpdateOne {
	if t != nil {
		to.SetCreatedAt(*t)
	}
	return to
...
// SetName sets the "name" field.
func (to *Todo2UpdateOne) SetName(s string) *Todo2UpdateOne {
	to.mutation.SetName(s)
	return to
}

// SetNillableName sets the "name" field if the given value is not nil.
func (to *Todo2UpdateOne) SetNillableName(s *string) *Todo2UpdateOne {
	if s != nil {
		to.SetName(*s)
	}
	return to
...
func (to *Todo2UpdateOne) sqlSave(ctx context.Context) (_node *Todo2, err error) {
	...
	if value, ok := to.mutation.CreatedAt(); ok {
		_spec.SetField(todo2.FieldCreatedAt, field.TypeTime, value)
	}
