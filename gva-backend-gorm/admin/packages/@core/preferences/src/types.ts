...
type SupportedLanguagesType = 'en-US' | 'km-KH' | 'zh-CN';
...
interface SidebarPreferences {
  ...
  collapsed: boolean;
  /** When the sidebar folds, do you display title*/
  collapsedShowTitle: boolean;
  /** Whether the sidebar can be visible*/
  enable: boolean;
  /** menu automatically expands status*/
  expandOnHover: boolean;
  /** Whether the sidebar expansion area is folded*/
  extraCollapse: boolean;
  /** Whether the sidebar is hidden -CSS*/
  hidden: boolean;
  /** The width of the sidebar of the side border*/
  width: number;
}
