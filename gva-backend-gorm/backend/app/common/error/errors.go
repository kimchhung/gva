...
var (
	...
	ErrCompanyExists         = newPublicError(http.StatusConflict, -21, "company_already_exists")

	// admins
	ErrUsernameExists = newPublicError(http.StatusConflict, -500, "username_already_exists")
	...
	// roles (400 - 499)
	ErrAdminRoleIsInUse = newPublicError(http.StatusConflict, -400, "role_is_in_use")
)
