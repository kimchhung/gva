...
func RequireAny(permissions ...permissionScope) echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		rctx, rerr := appctx.GetRequestContext(c.Request().Context())
		if rerr != nil {
			return rerr
		}
...
func RequireAnyWithSuper(permissions ...permissionScope) echo.HandlerFunc {
	return RequireAny(WithSuper(permissions...)...)
}
