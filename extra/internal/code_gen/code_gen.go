...
import (
	...
	module_template "github.com/kimchhung/gva/extra/internal/code_gen/module"
)
...
func Appends(params CodeGenParams) {
	InjectCodeToPos("main.go", map[string]string{
		...
		"// #inject:moduleImport": fmt.Sprintf(`"github.com/kimchhung/gva/extra/api/dashboard/module/%v"`+"\n", params.EntitySnake),
	}, true)
}
