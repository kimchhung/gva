...
func Pid(v pxid.ID) predicate.Department {
...
func PidEqualFold(v pxid.ID) predicate.Department {
	vc := string(v)
...
func PidContainsFold(v pxid.ID) predicate.Department {
	vc := string(v)
