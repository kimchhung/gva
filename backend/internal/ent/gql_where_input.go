...
// MyTodoWhereInput represents a where input for filtering MyTodo queries.
type MyTodoWhereInput struct {
	Predicates []predicate.MyTodo  `json:"-"`
	Not        *MyTodoWhereInput   `json:"not,omitempty"`
	Or         []*MyTodoWhereInput `json:"or,omitempty"`
	And        []*MyTodoWhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *MyTodoWhereInput) AddPredicates(predicates ...predicate.MyTodo) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the MyTodoWhereInput filter on the MyTodoQuery builder.
func (i *MyTodoWhereInput) Filter(q *MyTodoQuery) (*MyTodoQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyMyTodoWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyMyTodoWhereInput is returned in case the MyTodoWhereInput is empty.
var ErrEmptyMyTodoWhereInput = errors.New("ent: empty predicate MyTodoWhereInput")

// P returns a predicate for filtering mytodos.
// An error is returned if the input is empty or invalid.
func (i *MyTodoWhereInput) P() (predicate.MyTodo, error) {
	var predicates []predicate.MyTodo
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, mytodo.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
	...
	case n > 1:
		...
		predicates = append(predicates, mytodo.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
	...
	case n > 1:
		...
		predicates = append(predicates, mytodo.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, mytodo.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, mytodo.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, mytodo.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, mytodo.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, mytodo.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, mytodo.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, mytodo.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, mytodo.IDLTE(*i.IDLTE))
	}
	if i.CreatedAt != nil {
		predicates = append(predicates, mytodo.CreatedAtEQ(*i.CreatedAt))
	}
	if i.CreatedAtNEQ != nil {
		predicates = append(predicates, mytodo.CreatedAtNEQ(*i.CreatedAtNEQ))
	}
	if len(i.CreatedAtIn) > 0 {
		predicates = append(predicates, mytodo.CreatedAtIn(i.CreatedAtIn...))
	}
	if len(i.CreatedAtNotIn) > 0 {
		predicates = append(predicates, mytodo.CreatedAtNotIn(i.CreatedAtNotIn...))
	}
	if i.CreatedAtGT != nil {
		predicates = append(predicates, mytodo.CreatedAtGT(*i.CreatedAtGT))
	}
	if i.CreatedAtGTE != nil {
		predicates = append(predicates, mytodo.CreatedAtGTE(*i.CreatedAtGTE))
	}
	if i.CreatedAtLT != nil {
		predicates = append(predicates, mytodo.CreatedAtLT(*i.CreatedAtLT))
	}
	if i.CreatedAtLTE != nil {
		predicates = append(predicates, mytodo.CreatedAtLTE(*i.CreatedAtLTE))
	}
	if i.UpdatedAt != nil {
		predicates = append(predicates, mytodo.UpdatedAtEQ(*i.UpdatedAt))
	}
	if i.UpdatedAtNEQ != nil {
		predicates = append(predicates, mytodo.UpdatedAtNEQ(*i.UpdatedAtNEQ))
	}
	if len(i.UpdatedAtIn) > 0 {
		predicates = append(predicates, mytodo.UpdatedAtIn(i.UpdatedAtIn...))
	}
	if len(i.UpdatedAtNotIn) > 0 {
		predicates = append(predicates, mytodo.UpdatedAtNotIn(i.UpdatedAtNotIn...))
	}
	if i.UpdatedAtGT != nil {
		predicates = append(predicates, mytodo.UpdatedAtGT(*i.UpdatedAtGT))
	}
	if i.UpdatedAtGTE != nil {
		predicates = append(predicates, mytodo.UpdatedAtGTE(*i.UpdatedAtGTE))
	}
	if i.UpdatedAtLT != nil {
		predicates = append(predicates, mytodo.UpdatedAtLT(*i.UpdatedAtLT))
	}
	if i.UpdatedAtLTE != nil {
		predicates = append(predicates, mytodo.UpdatedAtLTE(*i.UpdatedAtLTE))
	}
	if i.DeletedAt != nil {
		predicates = append(predicates, mytodo.DeletedAtEQ(*i.DeletedAt))
	}
	if i.DeletedAtNEQ != nil {
		predicates = append(predicates, mytodo.DeletedAtNEQ(*i.DeletedAtNEQ))
	}
	if len(i.DeletedAtIn) > 0 {
		predicates = append(predicates, mytodo.DeletedAtIn(i.DeletedAtIn...))
	}
	if len(i.DeletedAtNotIn) > 0 {
		predicates = append(predicates, mytodo.DeletedAtNotIn(i.DeletedAtNotIn...))
	}
	if i.DeletedAtGT != nil {
		predicates = append(predicates, mytodo.DeletedAtGT(*i.DeletedAtGT))
	}
	if i.DeletedAtGTE != nil {
		predicates = append(predicates, mytodo.DeletedAtGTE(*i.DeletedAtGTE))
	}
	if i.DeletedAtLT != nil {
		predicates = append(predicates, mytodo.DeletedAtLT(*i.DeletedAtLT))
	}
	if i.DeletedAtLTE != nil {
		predicates = append(predicates, mytodo.DeletedAtLTE(*i.DeletedAtLTE))
	}
	if i.Name != nil {
		predicates = append(predicates, mytodo.NameEQ(*i.Name))
	}
	if i.NameNEQ != nil {
		predicates = append(predicates, mytodo.NameNEQ(*i.NameNEQ))
	}
	if len(i.NameIn) > 0 {
		predicates = append(predicates, mytodo.NameIn(i.NameIn...))
	}
	if len(i.NameNotIn) > 0 {
		predicates = append(predicates, mytodo.NameNotIn(i.NameNotIn...))
	}
	if i.NameGT != nil {
		predicates = append(predicates, mytodo.NameGT(*i.NameGT))
	}
	if i.NameGTE != nil {
		predicates = append(predicates, mytodo.NameGTE(*i.NameGTE))
	}
	if i.NameLT != nil {
		predicates = append(predicates, mytodo.NameLT(*i.NameLT))
	}
	if i.NameLTE != nil {
		predicates = append(predicates, mytodo.NameLTE(*i.NameLTE))
	}
	if i.NameContains != nil {
		predicates = append(predicates, mytodo.NameContains(*i.NameContains))
	}
	if i.NameHasPrefix != nil {
		predicates = append(predicates, mytodo.NameHasPrefix(*i.NameHasPrefix))
	}
	if i.NameHasSuffix != nil {
		predicates = append(predicates, mytodo.NameHasSuffix(*i.NameHasSuffix))
	}
	if i.NameEqualFold != nil {
		predicates = append(predicates, mytodo.NameEqualFold(*i.NameEqualFold))
	}
	if i.NameContainsFold != nil {
		predicates = append(predicates, mytodo.NameContainsFold(*i.NameContainsFold))
	}

	switch len(predicates) {
	case 0:
		return nil, ErrEmptyMyTodoWhereInput
	case 1:
		return predicates[0], nil
	default:
		return mytodo.And(predicates...), nil
	}
}

// MyTodo1WhereInput represents a where input for filtering MyTodo1 queries.
type MyTodo1WhereInput struct {
	Predicates []predicate.MyTodo1  `json:"-"`
	Not        *MyTodo1WhereInput   `json:"not,omitempty"`
	Or         []*MyTodo1WhereInput `json:"or,omitempty"`
	And        []*MyTodo1WhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *MyTodo1WhereInput) AddPredicates(predicates ...predicate.MyTodo1) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the MyTodo1WhereInput filter on the MyTodo1Query builder.
func (i *MyTodo1WhereInput) Filter(q *MyTodo1Query) (*MyTodo1Query, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyMyTodo1WhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyMyTodo1WhereInput is returned in case the MyTodo1WhereInput is empty.
var ErrEmptyMyTodo1WhereInput = errors.New("ent: empty predicate MyTodo1WhereInput")

// P returns a predicate for filtering mytodo1s.
// An error is returned if the input is empty or invalid.
func (i *MyTodo1WhereInput) P() (predicate.MyTodo1, error) {
	var predicates []predicate.MyTodo1
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, mytodo1.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
	...
	case n > 1:
		...
		predicates = append(predicates, mytodo1.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.MyTodo1, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, mytodo1.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, mytodo1.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, mytodo1.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, mytodo1.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, mytodo1.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, mytodo1.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, mytodo1.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, mytodo1.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, mytodo1.IDLTE(*i.IDLTE))
	}
	if i.CreatedAt != nil {
		predicates = append(predicates, mytodo1.CreatedAtEQ(*i.CreatedAt))
	}
	if i.CreatedAtNEQ != nil {
		predicates = append(predicates, mytodo1.CreatedAtNEQ(*i.CreatedAtNEQ))
	}
	if len(i.CreatedAtIn) > 0 {
		predicates = append(predicates, mytodo1.CreatedAtIn(i.CreatedAtIn...))
	}
	if len(i.CreatedAtNotIn) > 0 {
		predicates = append(predicates, mytodo1.CreatedAtNotIn(i.CreatedAtNotIn...))
	}
	if i.CreatedAtGT != nil {
		predicates = append(predicates, mytodo1.CreatedAtGT(*i.CreatedAtGT))
	}
	if i.CreatedAtGTE != nil {
		predicates = append(predicates, mytodo1.CreatedAtGTE(*i.CreatedAtGTE))
	}
	if i.CreatedAtLT != nil {
		predicates = append(predicates, mytodo1.CreatedAtLT(*i.CreatedAtLT))
	}
	if i.CreatedAtLTE != nil {
		predicates = append(predicates, mytodo1.CreatedAtLTE(*i.CreatedAtLTE))
	}
	if i.UpdatedAt != nil {
		predicates = append(predicates, mytodo1.UpdatedAtEQ(*i.UpdatedAt))
	}
	if i.UpdatedAtNEQ != nil {
		predicates = append(predicates, mytodo1.UpdatedAtNEQ(*i.UpdatedAtNEQ))
	}
	if len(i.UpdatedAtIn) > 0 {
		predicates = append(predicates, mytodo1.UpdatedAtIn(i.UpdatedAtIn...))
	}
	if len(i.UpdatedAtNotIn) > 0 {
		predicates = append(predicates, mytodo1.UpdatedAtNotIn(i.UpdatedAtNotIn...))
	}
	if i.UpdatedAtGT != nil {
		predicates = append(predicates, mytodo1.UpdatedAtGT(*i.UpdatedAtGT))
	}
	if i.UpdatedAtGTE != nil {
		predicates = append(predicates, mytodo1.UpdatedAtGTE(*i.UpdatedAtGTE))
	}
	if i.UpdatedAtLT != nil {
		predicates = append(predicates, mytodo1.UpdatedAtLT(*i.UpdatedAtLT))
	}
	if i.UpdatedAtLTE != nil {
		predicates = append(predicates, mytodo1.UpdatedAtLTE(*i.UpdatedAtLTE))
	}
	if i.DeletedAt != nil {
		predicates = append(predicates, mytodo1.DeletedAtEQ(*i.DeletedAt))
	}
	if i.DeletedAtNEQ != nil {
		predicates = append(predicates, mytodo1.DeletedAtNEQ(*i.DeletedAtNEQ))
	}
	if len(i.DeletedAtIn) > 0 {
		predicates = append(predicates, mytodo1.DeletedAtIn(i.DeletedAtIn...))
	}
	if len(i.DeletedAtNotIn) > 0 {
		predicates = append(predicates, mytodo1.DeletedAtNotIn(i.DeletedAtNotIn...))
	}
	if i.DeletedAtGT != nil {
		predicates = append(predicates, mytodo1.DeletedAtGT(*i.DeletedAtGT))
	}
	if i.DeletedAtGTE != nil {
		predicates = append(predicates, mytodo1.DeletedAtGTE(*i.DeletedAtGTE))
	}
	if i.DeletedAtLT != nil {
		predicates = append(predicates, mytodo1.DeletedAtLT(*i.DeletedAtLT))
	}
	if i.DeletedAtLTE != nil {
		predicates = append(predicates, mytodo1.DeletedAtLTE(*i.DeletedAtLTE))
	}
	if i.Name != nil {
		predicates = append(predicates, mytodo1.NameEQ(*i.Name))
	}
	if i.NameNEQ != nil {
		predicates = append(predicates, mytodo1.NameNEQ(*i.NameNEQ))
	}
	if len(i.NameIn) > 0 {
		predicates = append(predicates, mytodo1.NameIn(i.NameIn...))
	}
	if len(i.NameNotIn) > 0 {
		predicates = append(predicates, mytodo1.NameNotIn(i.NameNotIn...))
	}
	if i.NameGT != nil {
		predicates = append(predicates, mytodo1.NameGT(*i.NameGT))
	}
	if i.NameGTE != nil {
		predicates = append(predicates, mytodo1.NameGTE(*i.NameGTE))
	}
	if i.NameLT != nil {
		predicates = append(predicates, mytodo1.NameLT(*i.NameLT))
	}
	if i.NameLTE != nil {
		predicates = append(predicates, mytodo1.NameLTE(*i.NameLTE))
	}
	if i.NameContains != nil {
		predicates = append(predicates, mytodo1.NameContains(*i.NameContains))
	}
	if i.NameHasPrefix != nil {
		predicates = append(predicates, mytodo1.NameHasPrefix(*i.NameHasPrefix))
	}
	if i.NameHasSuffix != nil {
		predicates = append(predicates, mytodo1.NameHasSuffix(*i.NameHasSuffix))
	}
	if i.NameEqualFold != nil {
		predicates = append(predicates, mytodo1.NameEqualFold(*i.NameEqualFold))
	}
	if i.NameContainsFold != nil {
		predicates = append(predicates, mytodo1.NameContainsFold(*i.NameContainsFold))
	}

	switch len(predicates) {
	case 0:
		return nil, ErrEmptyMyTodo1WhereInput
	case 1:
		return predicates[0], nil
	default:
		return mytodo1.And(predicates...), nil
	}
}
