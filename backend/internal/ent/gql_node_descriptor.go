...
// Node implements Noder interface
func (mt *MyTodo) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     mt.ID,
		Type:   "MyTodo",
		Fields: make([]*Field, 4),
	...
	if buf, err = json.Marshal(mt.DeletedAt); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "int",
...
// Node implements Noder interface
func (mt *MyTodo1) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     mt.ID,
		Type:   "MyTodo1",
		Fields: make([]*Field, 4),
