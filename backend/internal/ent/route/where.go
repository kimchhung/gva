...
func ParentID(v xid.ID) predicate.Route {
...
func ParentIDContains(v xid.ID) predicate.Route {
	vc := string(v)
...
func ParentIDHasPrefix(v xid.ID) predicate.Route {
	vc := string(v)
...
func ParentIDHasSuffix(v xid.ID) predicate.Route {
	vc := string(v)
...
func ParentIDEqualFold(v xid.ID) predicate.Route {
	vc := string(v)
...
func ParentIDContainsFold(v xid.ID) predicate.Route {
	vc := string(v)
