...
-- Create "comics" table
CREATE TABLE `comics` (`id` varchar(21) NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, `chapter` bigint unsigned NOT NULL, `title` varchar(255) NOT NULL, `slug` varchar(255) NOT NULL, `covers` json NOT NULL, `status` varchar(255) NOT NULL, `is_translate_completed` bool NOT NULL DEFAULT 0, `up_count` bigint unsigned NOT NULL DEFAULT 0, `last_chapter_id` varchar(21) NULL, `final_chapter_id` varchar(21) NULL, PRIMARY KEY (`id`), INDEX `comics_comic_chapters_final_chapter` (`final_chapter_id`), INDEX `comics_comic_chapters_last_chapter` (`last_chapter_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
-- Create "genres" table
...
CREATE TABLE `permissions` (`id` varchar(21) NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, `group` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `key` varchar(255) NOT NULL, `order` bigint NOT NULL, PRIMARY KEY (`id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
-- Create "role_permissions" table
CREATE TABLE `role_permissions` (`role_id` varchar(21) NOT NULL, `permission_id` varchar(21) NOT NULL, PRIMARY KEY (`role_id`, `permission_id`), INDEX `role_permissions_permission_id` (`permission_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
-- Create "role_routes" table
CREATE TABLE `role_routes` (`role_id` varchar(21) NOT NULL, `route_id` varchar(21) NOT NULL, PRIMARY KEY (`role_id`, `route_id`), INDEX `role_routes_route_id` (`route_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
-- Create "roles" table
CREATE TABLE `roles` (`id` varchar(21) NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, `is_enable` bool NOT NULL DEFAULT 1, `deleted_at` bigint NOT NULL DEFAULT 0, `name` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `order` bigint NOT NULL, `is_changeable` bool NOT NULL, PRIMARY KEY (`id`), INDEX `role_deleted_at` (`deleted_at`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
-- Create "routes" table
CREATE TABLE `routes` (`id` varchar(21) NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, `is_enable` bool NOT NULL DEFAULT 1, `deleted_at` bigint NOT NULL DEFAULT 0, `path` varchar(255) NOT NULL, `component` varchar(255) NOT NULL, `redirect` varchar(255) NULL, `name` varchar(255) NOT NULL, `order` bigint NULL DEFAULT 0, `type` enum('cata_log','menu','button','external_link') NOT NULL DEFAULT "cata_log", `meta` json NOT NULL, `parent_id` varchar(21) NULL, PRIMARY KEY (`id`), INDEX `route_deleted_at` (`deleted_at`), UNIQUE INDEX `route_path_parent_id_type_deleted_at` (`path`, `parent_id`, `type`, `deleted_at`), INDEX `routes_routes_children` (`parent_id`), CONSTRAINT `routes_routes_children` FOREIGN KEY (`parent_id`) REFERENCES `routes` (`id`) ON UPDATE NO ACTION ON DELETE SET NULL) CHARSET utf8mb4 COLLATE utf8mb4_bin;
