...
func (pq *PermissionQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (pq *PermissionQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (pq *PermissionQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (pq *PermissionQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (pq *PermissionQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (pq *PermissionQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PermissionQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Role)) error {
	...
	byID := make(map[pulid.ID]*Permission)
	nids := make(map[pulid.ID]map[*Permission]struct{})
