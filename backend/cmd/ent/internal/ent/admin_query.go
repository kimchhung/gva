...
func (aq *AdminQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (aq *AdminQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (aq *AdminQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (aq *AdminQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (aq *AdminQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (aq *AdminQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AdminQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Admin, init func(*Admin), assign func(*Admin, *Role)) error {
	...
	byID := make(map[pulid.ID]*Admin)
	nids := make(map[pulid.ID]map[*Admin]struct{})
