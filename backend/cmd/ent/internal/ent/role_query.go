...
func (rq *RoleQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (rq *RoleQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (rq *RoleQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (rq *RoleQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (rq *RoleQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (rq *RoleQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (rq *RoleQuery) loadAdmins(ctx context.Context, query *AdminQuery, nodes []*Role, init func(*Role), assign func(*Role, *Admin)) error {
	...
	byID := make(map[pulid.ID]*Role)
	nids := make(map[pulid.ID]map[*Role]struct{})
