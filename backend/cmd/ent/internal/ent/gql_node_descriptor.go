...
// Node implements Noder interface
func (c *Comic) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     c.ID,
		Type:   "Comic",
	...
	if buf, err = json.Marshal(c.Chapter); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "uint",
	...
	if buf, err = json.Marshal(c.Slug); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(c.Covers); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "[]types.CoverImg",
	...
	if buf, err = json.Marshal(c.IsTranslateCompleted); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "bool",
		Name:  "isTranslateCompleted",
		Value: string(buf),
	}
	if buf, err = json.Marshal(c.UpCount); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "uint",
	...
	if buf, err = json.Marshal(c.FinalChapterID); err != nil {
		return nil, err
	}
	node.Fields[9] = &Field{
		Type:  "pulid.ID",
		Name:  "final_chapter_id",
		Value: string(buf),
	}
	if buf, err = json.Marshal(c.LastChapterID); err != nil {
		return nil, err
	}
...
// Node implements Noder interface
func (cc *ComicChapter) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     cc.ID,
		Type:   "ComicChapter",
		Fields: make([]*Field, 9),
	...
	if buf, err = json.Marshal(cc.Chapter); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "uint",
	...
	if buf, err = json.Marshal(cc.Title); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(cc.Volumn); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(cc.Lang); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(cc.UpCount); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "uint",
	...
	if buf, err = json.Marshal(cc.DownCount); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "uint",
	...
	if buf, err = json.Marshal(cc.IsLastChapter); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "bool",
		Name:  "is_last_chapter",
		Value: string(buf),
	}
	node.Edges[0] = &Edge{
		Type: "ComicImg",
...
// Node implements Noder interface
func (ci *ComicImg) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     ci.ID,
		Type:   "ComicImg",
		Fields: make([]*Field, 8),
	...
	if buf, err = json.Marshal(ci.B2key); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(ci.Height); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(ci.Name); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(ci.OptimizedSize); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "int64",
	...
	if buf, err = json.Marshal(ci.Size); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "int64",
	...
	if buf, err = json.Marshal(ci.Width); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "int",
