...
func (pu *PermissionUpdate) AddRoleIDs(ids ...pulid.ID) *PermissionUpdate {
...
func (pu *PermissionUpdate) RemoveRoleIDs(ids ...pulid.ID) *PermissionUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (puo *PermissionUpdateOne) AddRoleIDs(ids ...pulid.ID) *PermissionUpdateOne {
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (puo *PermissionUpdateOne) RemoveRoleIDs(ids ...pulid.ID) *PermissionUpdateOne {
