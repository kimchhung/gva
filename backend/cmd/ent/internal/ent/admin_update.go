...
func (au *AdminUpdate) AddRoleIDs(ids ...pulid.ID) *AdminUpdate {
...
func (au *AdminUpdate) RemoveRoleIDs(ids ...pulid.ID) *AdminUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (auo *AdminUpdateOne) AddRoleIDs(ids ...pulid.ID) *AdminUpdateOne {
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (auo *AdminUpdateOne) RemoveRoleIDs(ids ...pulid.ID) *AdminUpdateOne {
