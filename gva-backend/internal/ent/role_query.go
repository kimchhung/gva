...
func (rq *RoleQuery) FirstIDX(ctx context.Context) pxid.ID {
...
func (rq *RoleQuery) OnlyIDX(ctx context.Context) pxid.ID {
...
func (rq *RoleQuery) IDs(ctx context.Context) (ids []pxid.ID, err error) {
...
func (rq *RoleQuery) IDsX(ctx context.Context) []pxid.ID {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
