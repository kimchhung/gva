  ...
  <div class="p-5">
    ...
    <div class="card-box mt-5 p-5">
      ...
      <div class="flex flex-wrap gap-3">
        ...
        <Button type="primary" @click="closeTabByKey('/gva-admin/about')">
          关闭 "关于" 标签页
        </Button>
      </div>
    </div>
    ...
    <div class="card-box mt-5 p-5">
      ...
      <div class="flex flex-wrap gap-3">
        <Button type="primary" @click="closeCurrentTab()"> 关闭当前标签页 </Button>
        <Button type="primary" @click="closeLeftTabs()"> 关闭左侧标签页 </Button>
        <Button type="primary" @click="closeRightTabs()"> 关闭右侧标签页 </Button>
        <Button type="primary" @click="closeAllTabs()"> 关闭所有标签页 </Button>
        <Button type="primary" @click="closeOtherTabs()"> 关闭其他标签页 </Button>
    ...
    <div class="card-box mt-5 p-5">
      ...
      <div class="text-foreground/80 my-3">该操作不会影响页面标题，仅修改Tab标题</div>
      <div class="flex flex-wrap items-center gap-3">
        <AInput v-model:value="newTabTitle" class="w-40" placeholder="请输入新标题" />
        <Button type="primary" @click="() => setTabTitle(newTabTitle)"> 修改 </Button>
    ...
    <div class="card-box mt-5 p-5">
      ...
      <div class="flex flex-wrap items-center gap-3">
        <template v-for="item in 5" :key="item">
          <Button type="primary" @click="openTabWithParams(item)"> 打开{{ item }}详情页 </Button>
        </template>
      </div>
    </div>
  </div>
