...
import { AccessControl, useAccess } from '@gva/access';
import { resetAllStores, useUserStore } from '@gva/stores';
  ...
  <div class="p-5">
    ...
    <div class="card-box mt-5 p-5">
      ...
      <AccessControl :codes="['AC_100100', 'AC_100010']" type="code">
        <Button class="mr-4"> Super & Admin 账号可见 ["AC_100100","AC_1000001"] </Button>
      </AccessControl>
    </div>
    ...
    <div class="card-box mt-5 p-5">
      ...
      <Button class="mr-4" v-access:code="['AC_100100']"> Super 账号可见 ["AC_1000001"] </Button>
