...
import { VbenButton, VbenCheckbox, VbenInput, VbenInputPassword } from '@gva-core/shadcn-ui';
...
function handleSubmit() {
  ...
  if (usernameStatus.value !== 'default' || passwordStatus.value !== 'default') {
    return;
  }

  localStorage.setItem(REMEMBER_ME_KEY, formState.rememberMe ? formState.username : '');
